...
from common.log_utils import get_log_path
from common.log_utils import logger
from contrib.serialization import Serializable
from contrib.serialization import flatten_dict
from contrib.serialization import inflate_dict
...
def to_wandb_config(params: Serializable) -> Dict:
    config_data = flatten_dict(params.to_dict())
