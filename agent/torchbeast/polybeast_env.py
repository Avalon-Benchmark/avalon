...
parser.add_argument('--num_servers', default=10, type=int, metavar='N',
...
parser.add_argument('--max_frames', default=120, type=int,
                    help='Max frames at 0 difficulty.')
...
def main(flags, exit_event: mp.Event):
    ...
    for i in range(flags.num_servers):
        env_config = godot_config_from_flags(flags, random_int=i + flags.env_seed)
